...
class Sampler:
    ...
    def sample(
        ...
        for noise_sample, generator_sample, discriminator_sample in zip(
            ...
            discriminator_sample_image = torch.zeros(noise_sample.shape).permute(1, 2, 0)
