...
class Generator(nn.Module):
    ...
    def __init__(self, device: torch.device = torch.device("cpu"), *args, **kwargs) -> None:
        ...
        self.encoder_1_1 = nn.Conv2d(3, 64, kernel_size=3, padding=1)
        self.encoder_1_2 = nn.Conv2d(64, 64, kernel_size=3, padding=1)
        self.pool_1 = nn.MaxPool2d(kernel_size=2, stride=2)

        self.encoder_2_1 = nn.Conv2d(64, 128, kernel_size=3, padding=1)
        self.encoder_2_2 = nn.Conv2d(128, 128, kernel_size=3, padding=1)
        self.pool_2 = nn.MaxPool2d(kernel_size=2, stride=2)

        self.encoder_3_1 = nn.Conv2d(128, 256, kernel_size=3, padding=1)
        self.encoder_3_2 = nn.Conv2d(256, 256, kernel_size=3, padding=1)
        self.pool_3 = nn.MaxPool2d(kernel_size=2, stride=2)

        self.encoder_4_1 = nn.Conv2d(256, 512, kernel_size=3, padding=1)
        self.encoder_4_2 = nn.Conv2d(512, 512, kernel_size=3, padding=1)
        self.pool_4 = nn.MaxPool2d(kernel_size=2, stride=2)

        self.encoder_5_1 = nn.Conv2d(512, 1024, kernel_size=3, padding=1)
        self.encoder_5_2 = nn.Conv2d(1024, 1024, kernel_size=3, padding=1)

        self.upconv_1 = nn.ConvTranspose2d(1024, 512, kernel_size=2, stride=2)
        self.decoder_1_1 = nn.Conv2d(1024, 512, kernel_size=3, padding=1)
        self.decoder_1_2 = nn.Conv2d(512, 512, kernel_size=3, padding=1)

        self.upconv_2 = nn.ConvTranspose2d(512, 256, kernel_size=2, stride=2)
        self.decoder_2_1 = nn.Conv2d(512, 256, kernel_size=3, padding=1)
        self.decoder_2_2 = nn.Conv2d(256, 256, kernel_size=3, padding=1)

        self.upconv_3 = nn.ConvTranspose2d(256, 128, kernel_size=2, stride=2)
        self.decoder_3_1 = nn.Conv2d(256, 128, kernel_size=3, padding=1)
        self.decoder_3_2 = nn.Conv2d(128, 128, kernel_size=3, padding=1)

        self.upconv_4 = nn.ConvTranspose2d(128, 64, kernel_size=2, stride=2)
        self.decoder_4_1 = nn.Conv2d(128, 64, kernel_size=3, padding=1)
        self.decoder_4_2 = nn.Conv2d(64, 64, kernel_size=3, padding=1)
